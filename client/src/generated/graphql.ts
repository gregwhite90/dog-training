...
export type AddDogMutationMutationVariables = Exact<{
  input: AddDogInput;
}>;


export type AddDogMutationMutation = (
  { __typename?: 'Mutation' }
  & { addDog?: Maybe<(
    { __typename?: 'AddDogPayload' }
    & { dogEdge: (
...
export type CreateBehaviorMutationMutationVariables = Exact<{
  input: CreateBehaviorInput;
}>;


export type CreateBehaviorMutationMutation = (
  { __typename?: 'Mutation' }
  & { createBehavior?: Maybe<(
    { __typename?: 'CreateBehaviorPayload' }
    & { behaviorEdge: (
      { __typename?: 'BehaviorEdge' }
      & { node?: Maybe<(
...
export type EditDogMutationMutationVariables = Exact<{
  input: EditDogInput;
}>;


export type EditDogMutationMutation = (
  { __typename?: 'Mutation' }
  & { editDog?: Maybe<(
    { __typename?: 'EditDogPayload' }
    & { dog: (
...
export type InviteUserByEmailMutationMutationVariables = Exact<{
  input: InviteUserByEmailInput;
}>;


export type InviteUserByEmailMutationMutation = (
  { __typename?: 'Mutation' }
  & { inviteUserByEmail?: Maybe<(
    { __typename?: 'InviteUserByEmailPayload' }
    & { viewer: (
      { __typename?: 'User' }
      & Pick<User, 'id'>
